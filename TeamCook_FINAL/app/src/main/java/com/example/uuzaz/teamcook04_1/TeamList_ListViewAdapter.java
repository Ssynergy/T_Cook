...
public class TeamList_ListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView team_leader_name_teamlistTextView = (TextView) convertView.findViewById(R.id.team_leader_name_teamlist) ;
        ...
        team_leader_name_teamlistTextView.setText(teamList_listItem.getTeam_leader_name_teamlist());
    ...
    public void addItem(String contest_day, String team_list_name, String d_day_team_list, String team_member, String team_leader_name_teamlist) {
        ...
        item.setTeam_leader_name_teamlist(team_leader_name_teamlist);
