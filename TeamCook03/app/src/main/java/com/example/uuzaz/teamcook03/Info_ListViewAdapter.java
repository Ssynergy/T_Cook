...
public class Info_ListViewAdapter extends ArrayAdapter implements View.OnClickListener{
    ...
    private ListBtnClickListener listBtnClickListener2 ;
...
*/
        ...
        ImageButton button2 = (ImageButton) convertView.findViewById(R.id.info_picture);
        button2.setTag(position);
        button2.setOnClickListener(this);

        Button button3 = (Button) convertView.findViewById(R.id.team_create_btn);
...
//    Button start = (Button) convertView.findViewById(R.id.btn_create_team_temp);
